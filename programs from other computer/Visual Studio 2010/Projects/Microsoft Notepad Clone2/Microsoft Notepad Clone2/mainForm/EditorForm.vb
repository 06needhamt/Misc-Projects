Public Class EditorForm
    ...
    Private Sub mainForm_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        ...
        If CloseReason.UserClosing Then
            ...
            Else
                End
                'if it hasn't, then "Houston we are clear for shutdown." :)
            End If
        End If
    ...
    Private Sub txtMain_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtMain.DoubleClick
        txtMain.Focus()
    End Sub
End Class